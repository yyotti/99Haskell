...
spec = do
  ...
  describe "Problem 50" $ do
    it "returns empty list" $ do
      huffman ([] :: [(Char, Int)]) `shouldBe` []
    it "returns [('a', \"\")] if ls = [('a', 45)]" $ do
      huffman [('a', 45)] `shouldBe` [('a', "")]
    it "returns [('a', \"0\"), ('b', \"1\")] if ls = [('a', 45), ('b', 13)]" $ do
      huffman [('a', 45), ('b', 13)] `shouldBe` [('a', "1"), ('b', "0")]
    it "returns huffman code list if ls = [('a', 45), ('b', 13), ('c', 12), ('d', 16), ('e', 9), ('f', 5)]" $ do
